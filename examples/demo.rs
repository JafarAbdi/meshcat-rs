...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    meshcat.set_object(
        "/tetrahedron",
        LumpedObject::builder()
            .geometries(vec![Geometry::new(GeometryType::Tetrahedron {
                radius: 0.5,
                detail: 0,
            })])
    ...
    meshcat.set_object(
        "/ring",
        LumpedObject::builder()
            .geometries(vec![Geometry::new(GeometryType::Ring {
                inner_radius: 0.5,
                outer_radius: 1.0,
                theta_segments: 32,
                phi_segments: 1,
    ...
    meshcat.set_object(
        "/octahedron",
        LumpedObject::builder()
            .geometries(vec![Geometry::new(GeometryType::Octahedron {
                radius: 0.5,
                detail: 0,
            })])
            .object(Object::new(
    ...
    meshcat.set_object(
        "/icosahedron",
        LumpedObject::builder()
            .geometries(vec![Geometry::new(GeometryType::Icosahedron {
                radius: 0.5,
                detail: 0,
            })])
            .object(Object::new(
    ...
    meshcat.set_object(
        "/dodecahedron",
        LumpedObject::builder()
            .geometries(vec![Geometry::new(GeometryType::Dodecahedron {
                radius: 0.5,
                detail: 0,
            })])
            .object(Object::new(
    ...
    meshcat.set_object(
        "/cone",
        LumpedObject::builder()
            .geometries(vec![Geometry::new(GeometryType::Cone {
                radius: 0.5,
                height: 1.0,
                radial_segments: 32,
                height_segments: 1,
